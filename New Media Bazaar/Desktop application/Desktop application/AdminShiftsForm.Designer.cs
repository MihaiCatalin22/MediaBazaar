namespace Desktop_application
{
	partial class AdminShiftsForm
	{
		...
		private void InitializeComponent()
		{
			...
			// bttnVacation
			// 
			bttnVacation.BackColor = Color.Black;
			bttnVacation.FlatAppearance.BorderSize = 0;
			bttnVacation.FlatStyle = FlatStyle.Flat;
			bttnVacation.Font = new Font("Microsoft Sans Serif", 10.2F, FontStyle.Regular, GraphicsUnit.Point);
			bttnVacation.ForeColor = Color.White;
			bttnVacation.Location = new Point(12, 148);
			bttnVacation.Margin = new Padding(3, 4, 3, 4);
			bttnVacation.Name = "bttnVacation";
			bttnVacation.Size = new Size(154, 30);
			bttnVacation.TabIndex = 54;
			bttnVacation.Text = "Check Vacations";
			bttnVacation.UseVisualStyleBackColor = false;
			bttnVacation.Click += bttnVacation_Click;
			// 
			// AdminShiftsForm
			// 
